...
<body class="nk-body ui-rounder has-sidebar ui-light ">
    ...
    <ul class="nk-sticky-toolbar">
        <li class="demo-thumb bg-white border">
            <a class="tipinfo" href="{{route('index_accueil_vehicule')}}" title="Véhicules">
                <div class="user-avatar sm sq" style="background: transparent;">
                    <img src="{{asset('images/logo/selects/car.jpg')}}" alt="Véhicules" class="thumb">
                </div>
            </a>
        </li>
        <li class="demo-thumb bg-white border">
            <a class="tipinfo" href="" title="Immobiliers">
                <div class="user-avatar sm sq" style="background: transparent;">
                    <img src="{{asset('images/logo/selects/immeuble.jpg')}}" alt="Immobiliers" class="thumb">
                </div>
            </a>
        </li>
    </ul>
